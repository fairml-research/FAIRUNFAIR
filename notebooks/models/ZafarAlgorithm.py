...
class ZafarAlgorithmBaselineNEW(ZafarAlgorithmBase):
...
class ZafarAlgorithmAccuracyNEW(ZafarAlgorithmBase):
...
class ZafarAlgorithmFairnessNEW(ZafarAlgorithmBase):
