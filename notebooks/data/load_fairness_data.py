...
def _get_data_func_compass(num,sens,y,columns_delete):
    ...
    X_train0 = X_train.drop(columns_delete,axis=1)
    X_test0 = X_test.drop(columns_delete,axis=1)
    ...
    X_train = X_train.drop(columns_delete,axis=1).values
    X_test = X_test.drop(columns_delete,axis=1).values
